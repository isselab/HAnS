...
public class FeatureModelGroupModifierImpl extends ASTWrapperPsiElement implements FeatureModelGroupModifier {

  public FeatureModelGroupModifierImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FeatureModelVisitor visitor) {
    visitor.visitGroupModifier(this);
  }
