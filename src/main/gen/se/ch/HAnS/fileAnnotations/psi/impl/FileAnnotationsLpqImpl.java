...
public class FileAnnotationsLpqImpl extends ASTWrapperPsiElement implements FileAnnotationsLpq {

  public FileAnnotationsLpqImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<FileAnnotationsFeatureName> getFeatureNameList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, FileAnnotationsFeatureName.class);
  }
