...
public class FileAnnotationsFileNameImpl extends ASTWrapperPsiElement implements FileAnnotationsFileName {

  public FileAnnotationsFileNameImpl(@NotNull ASTNode node) {
    super(node);
  }
