...
public class FileAnnotationsFileReferenceImpl extends ASTWrapperPsiElement implements FileAnnotationsFileReference {

  public FileAnnotationsFileReferenceImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public FileAnnotationsFileName getFileName() {
    return findNotNullChildByClass(FileAnnotationsFileName.class);
  }
