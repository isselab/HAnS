...
*/
package se.isselab.HAnS.syntaxHighlighting.featureAnnotations.fileAnnotations;
...
import se.isselab.HAnS.featureAnnotation.fileAnnotation.psi.FileAnnotationFeatureName;
import se.isselab.HAnS.featureAnnotation.fileAnnotation.psi.FileAnnotationFileName;
import se.isselab.HAnS.featureAnnotation.fileAnnotation.psi.FileAnnotationLpq;
import se.isselab.HAnS.syntaxHighlighting.featureAnnotations.FeatureAnnotatorUtils;
...
public class FileAnnotationAnnotator implements Annotator {
    ...
    public void annotate(@NotNull PsiElement element, @NotNull AnnotationHolder holder) {
        ...
        for (FileAnnotationFeatureName feature : featureNames) {
            FeatureAnnotatorUtils.annotateFeatureReference(element, feature, holder);
        }
    }
