...
public class FeatureModelSyntaxHighlighter extends SyntaxHighlighterBase {
    ...
    public static final TextAttributesKey OPERAND =
            createTextAttributesKey("OPERAND", DefaultLanguageHighlighterColors.GLOBAL_VARIABLE);
    ...
    private static final TextAttributesKey[] OPERAND_KEYS = new TextAttributesKey[]{OPERAND};
    ...
    public TextAttributesKey @NotNull [] getTokenHighlights(IElementType tokenType) {
        if (tokenType.equals(FeatureModelTypes.FEATURENAME)){
            return FEATURE_KEYS;
        } else if (tokenType.equals(FeatureModelTypes.OPTIONAL) || tokenType.equals(FeatureModelTypes.XOR) || tokenType.equals(FeatureModelTypes.OR)) {
            return OPERAND_KEYS;
